...
var $author$project$Api$AccessToken = function (a) {
...
var $author$project$Api$RefreshToken = function (a) {
	return {$: 'RefreshToken', a: a};
};
...
var $author$project$Api$credDecoder = A3(
	...
	A2(
		$elm$json$Json$Decode$map,
		function (str) {
			return $author$project$Api$RefreshToken(str);
		},
	...
	A3(
		...
		A2(
			$elm$json$Json$Decode$map,
			function (str) {
				return $author$project$Api$AccessToken(str);
			},
			$elm$json$Json$Decode$string),
...
var $author$project$User$User = F6(
	function (id, firstName, lastName, email, phoneNumber, company) {
		return {company: company, email: email, firstName: firstName, id: id, lastName: lastName, phoneNumber: phoneNumber};
	});
...
var $author$project$Viewer$decoder = A2(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
	A2($elm$json$Json$Decode$field, 'info', $author$project$User$decoder),
...
var $author$project$Page$Home$ContactUs = {$: 'ContactUs'};
var $author$project$Page$Home$Features = {$: 'Features'};
var $author$project$Page$Home$Main = {$: 'Main'};
var $author$project$Page$Home$Model = F2(
	function (session, tabs) {
		return {session: session, tabs: tabs};
	});
var $author$project$Page$Home$Pricing = {$: 'Pricing'};
var $author$project$Tabs$Tabs = F3(
	function (before, current, after) {
		return {after: after, before: before, current: current};
	});
var $author$project$Page$Home$init = function (session) {
	var tabs = A3(
		$author$project$Tabs$Tabs,
		_List_Nil,
		$author$project$Page$Home$Main,
		_List_fromArray(
			[$author$project$Page$Home$Features, $author$project$Page$Home$Pricing, $author$project$Page$Home$ContactUs]));
	return _Utils_Tuple2(
		A2($author$project$Page$Home$Model, session, tabs),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Page$Login$Form = F4(
	function (email, password, showPassword, rememberMe) {
		return {email: email, password: password, rememberMe: rememberMe, showPassword: showPassword};
	});
var $author$project$Page$Login$Model = F3(
	function (session, form, problems) {
		return {form: form, problems: problems, session: session};
	});
...
var $author$project$Page$NotFound$init = function (session) {
	return _Utils_Tuple2(
		$author$project$Page$NotFound$Model(session),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Page$Signup$Form = F7(
	function (firstName, lastName, email, phoneNumber, password, showPassword, agree) {
		return {agree: agree, email: email, firstName: firstName, lastName: lastName, password: password, phoneNumber: phoneNumber, showPassword: showPassword};
	});
var $author$project$Page$Signup$Model = F3(
	function (session, form, problems) {
		return {form: form, problems: problems, session: session};
	});
var $author$project$Page$Signup$init = function (session) {
	return _Utils_Tuple2(
		A3(
			...
			session,
			A7($author$project$Page$Signup$Form, '', '', '', '', '', false, false),
			_List_Nil),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Page$Welcome$Welcome = function (a) {
	return {$: 'Welcome', a: a};
};
var $author$project$Page$Welcome$init = function (session) {
	return _Utils_Tuple2(
		$author$project$Page$Welcome$Welcome(session),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Page$Welcome$toSession = function (model) {
	switch (model.$) {
		case 'Welcome':
			var session = model.a;
			return session;
...
var $author$project$Meta$Default = {$: 'Default'};
var $author$project$Meta$English = {$: 'English'};
var $author$project$Meta$Meta = F3(
	function (language, theme, timeZone) {
		return {language: language, theme: theme, timeZone: timeZone};
	});
...
var $author$project$Meta$defaults = A3($author$project$Meta$Meta, $author$project$Meta$English, $author$project$Meta$Default, $elm$time$Time$utc);
var $author$project$Session$fromViewer = F2(
	function (key, maybeViewer) {
		if (maybeViewer.$ === 'Just') {
			var viewerVal = maybeViewer.a;
			return A3($author$project$Session$LoggedIn, $author$project$Meta$defaults, key, viewerVal);
		} else {
			return A2($author$project$Session$Guest, $author$project$Meta$defaults, key);
		}
	});
...
var $author$project$Page$NotFound$subscriptions = function (model) {
	return A2(
		$author$project$Session$changes,
		$author$project$Page$NotFound$GotSession,
		$author$project$Session$navKey(model.session));
};
var $author$project$Page$Signup$GotSession = function (a) {
	return {$: 'GotSession', a: a};
};
var $author$project$Page$Signup$subscriptions = function (model) {
	return A2(
		$author$project$Session$changes,
		$author$project$Page$Signup$GotSession,
		$author$project$Session$navKey(model.session));
};
var $author$project$Page$Welcome$GotSession = function (a) {
	return {$: 'GotSession', a: a};
};
var $author$project$Page$Welcome$subscriptions = function (model) {
	return A2(
		$author$project$Session$changes,
		$author$project$Page$Welcome$GotSession,
		$author$project$Session$navKey(
			$author$project$Page$Welcome$toSession(model)));
};
	...
	switch (model.$) {
		...
		case 'NotFound':
			...
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$GotNotFoundMsg,
				$author$project$Page$NotFound$subscriptions(notFound));
		case 'Home':
			var home = model.a;
			return A2(
				$elm$core$Platform$Sub$map,
		...
		case 'Signup':
			...
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$GotSignupMsg,
				$author$project$Page$Signup$subscriptions(signup));
		case 'Welcome':
			var welcome = model.a;
			return A2(
				$elm$core$Platform$Sub$map,
...
var $author$project$Session$meta = function (session) {
	if (session.$ === 'LoggedIn') {
		var val = session.a;
		return val;
	} else {
...
var $author$project$Tabs$splitAt = F2(
	function (subTabs, target) {
		var tail = $elm$core$List$tail(subTabs);
		var head = $elm$core$List$head(subTabs);
		var _v0 = _Utils_Tuple2(head, tail);
		if (_v0.a.$ === 'Just') {
			if (_v0.b.$ === 'Just') {
				var tab = _v0.a.a;
				var tabs = _v0.b.a;
				if (_Utils_eq(target, tab)) {
					return A3($author$project$Tabs$Tabs, _List_Nil, tab, tabs);
				} else {
					var _v1 = A2($author$project$Tabs$splitAt, tabs, target);
				...
				var tab = _v0.a.a;
				var _v2 = _v0.b;
				return A3($author$project$Tabs$Tabs, _List_Nil, tab, _List_Nil);
			}
		} else {
			if (_v0.b.$ === 'Just') {
				var _v3 = _v0.a;
				var tabs = _v0.b.a;
				return A3($author$project$Tabs$Tabs, _List_Nil, target, tabs);
			} else {
				var _v4 = _v0.a;
				var _v5 = _v0.b;
				return A3($author$project$Tabs$Tabs, _List_Nil, target, _List_Nil);
			}
		}
	});
var $author$project$Tabs$switchTo = F2(
	function (tabs, target) {
		if (_Utils_eq(tabs.current, target)) {
			return tabs;
		} else {
			if (A2($elm$core$List$member, target, tabs.before)) {
				var _v0 = A2($author$project$Tabs$splitAt, tabs.before, target);
				...
				if (A2($elm$core$List$member, target, tabs.after)) {
					var _v1 = A2($author$project$Tabs$splitAt, tabs.after, target);
					var before = _v1.before;
					var current = _v1.current;
					var after = _v1.after;
					return A3(
...
var $author$project$Session$updateMeta = F2(
	function (session, newMeta) {
		if (session.$ === 'Guest') {
			var key = session.b;
			return A2($author$project$Session$Guest, newMeta, key);
		} else {
			var key = session.b;
			var val = session.c;
			return A3($author$project$Session$LoggedIn, newMeta, key, val);
		}
	});
			...
			case 'ChangeFocus':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tabs: A2($author$project$Tabs$switchTo, model.tabs, section)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeLanguage':
				var lang = msg.a;
				var meta = $author$project$Session$meta(model.session);
				var session = A2(
					$author$project$Session$updateMeta,
					model.session,
					_Utils_update(
						meta,
						{language: lang}));
				return $author$project$Page$Home$init(session);
			case 'ChangeTheme':
				var theme = msg.a;
				var meta = $author$project$Session$meta(model.session);
				var session = A2(
...
var $author$project$ErrorHandling$httpErrorToString = function (httpErr) {
	switch (httpErr.$) {
		case 'BadUrl':
			var errMsg = httpErr.a;
			return errMsg;
		case 'Timeout':
			return 'Timeout';
		case 'NetworkError':
...
var $author$project$API$Object$Token$access = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'access', _List_Nil, $elm$json$Json$Decode$string);
...
var $author$project$API$Object$Token$refresh = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'refresh', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$Api$credSelectionSet = A3(
	$dillonkearns$elm_graphql$Graphql$SelectionSet$map2,
	$author$project$Api$Cred,
	A2(
		$dillonkearns$elm_graphql$Graphql$SelectionSet$map,
		function (str) {
			return $author$project$Api$AccessToken(str);
		},
		$author$project$API$Object$Token$access),
	A2(
		$dillonkearns$elm_graphql$Graphql$SelectionSet$map,
		function (str) {
			return $author$project$Api$RefreshToken(str);
		},
		$author$project$API$Object$Token$refresh));
...
var $author$project$API$Query$login = F3(
	function (fillInOptionals, requiredArgs, object_) {
		var filledInOptionals = fillInOptionals(
			{rememberMe: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
		var optionalArgs = A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
			_List_fromArray(
				[
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$optional, 'rememberMe', filledInOptionals.rememberMe, $dillonkearns$elm_graphql$Graphql$Internal$Encode$bool)
				]));
		return A4(
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'email', requiredArgs.email, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string),
						A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'password', requiredArgs.password, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)
					])),
			object_,
			$elm$core$Basics$identity);
	});
...
var $author$project$Api$makePublicQuery = F2(
	function (query, decodesTo) {
		return A2(
			$dillonkearns$elm_graphql$Graphql$Http$send,
			decodesTo,
			A2($dillonkearns$elm_graphql$Graphql$Http$queryRequest, $author$project$Api$api_url, query));
	});
var $author$project$API$Object$Login$token = function (object_) {
	return A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField, 'token', _List_Nil, object_, $elm$core$Basics$identity);
};
var $author$project$API$Object$Login$user = function (object_) {
	return A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField, 'user', _List_Nil, object_, $elm$core$Basics$identity);
};
var $author$project$Api$login = F3(
	function (form, msg, viewerSelectionSet) {
		var requiredFields = {email: form.email, password: form.password};
		var optionalFields = function (optionals) {
			return _Utils_update(
				optionals,
				{
					rememberMe: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(form.rememberMe)
				});
		};
		return A2(
			$author$project$Api$makePublicQuery,
			A3(
				$author$project$API$Query$login,
				optionalFields,
				requiredFields,
				A2(
					viewerSelectionSet,
					$author$project$API$Object$Login$user,
					$author$project$API$Object$Login$token($author$project$Api$credSelectionSet))),
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, msg));
	});
var $author$project$API$Scalar$DateTime = function (a) {
	return {$: 'DateTime', a: a};
};
...
var $author$project$API$Scalar$defaultCodecs = {
	codecDateTime: {
		decoder: A2($elm$json$Json$Decode$map, $author$project$API$Scalar$DateTime, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
...
var $author$project$API$ScalarCodecs$codecs = $author$project$API$Scalar$defineCodecs(
	{codecDateTime: $author$project$API$Scalar$defaultCodecs.codecDateTime, codecId: $author$project$API$Scalar$defaultCodecs.codecId});
var $author$project$API$Scalar$unwrapCodecs = function (_v0) {
	var unwrappedCodecs = _v0.a;
	return unwrappedCodecs;
};
var $author$project$API$Object$User$company = A4(
...
var $author$project$API$Object$User$email = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'email', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$API$Object$User$firstName = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'firstName', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$API$Object$User$id = A4(
	$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
	'ScalarCodecs.Id',
	'Id',
	_List_Nil,
	$author$project$API$Scalar$unwrapCodecs($author$project$API$ScalarCodecs$codecs).codecId.decoder);
var $author$project$API$Object$User$lastName = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'lastName', _List_Nil, $elm$json$Json$Decode$string);
...
var $author$project$User$maybeIdToMaybeString = function (maybeId) {
	if (maybeId.$ === 'Just') {
		var id = maybeId.a.a;
...
var $author$project$API$Object$User$phoneNumber = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'phoneNumber', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$User$selectionSet = A7(
	...
	A2(
		...
		$author$project$API$Object$User$id),
	$author$project$API$Object$User$firstName,
	$author$project$API$Object$User$lastName,
	$author$project$API$Object$User$email,
	$author$project$API$Object$User$phoneNumber,
	A2($dillonkearns$elm_graphql$Graphql$SelectionSet$map, $author$project$User$maybeIdToMaybeString, $author$project$API$Object$User$company));
var $author$project$Viewer$selectionSet = function (userToTypeLock) {
	return A2(
		$dillonkearns$elm_graphql$Graphql$SelectionSet$map2,
		$author$project$Viewer$Viewer,
		userToTypeLock($author$project$User$selectionSet));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'lastName',
				$elm$json$Json$Encode$string(user.lastName)),
				_Utils_Tuple2(
				'email',
				$elm$json$Json$Encode$string(user.email)),
				_Utils_Tuple2(
				'phoneNumber',
				$elm$json$Json$Encode$string(user.phoneNumber)),
				_Utils_Tuple2(
				'company',
				function () {
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'access',
								$elm$json$Json$Encode$string(access)),
								_Utils_Tuple2(
								'refresh',
								$elm$json$Json$Encode$string(refresh))
							])))
				]));
...
var $author$project$Viewer$store = function (_v0) {
	var infoVal = _v0.a;
	var credVal = _v0.b;
	return A2($author$project$Api$storeCredWith, credVal, infoVal);
};
		...
		switch (msg.$) {
			...
			case 'ToggleShowPassword':
				...
				return A2(
					...
					model);
			case 'SubmitForm':
				var _v1 = $author$project$Page$Login$validate(model.form);
				if (_v1.$ === 'Ok') {
					var validForm = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
						...
						A3(
							...
							$author$project$Page$Login$GotResponse,
							$author$project$Viewer$selectionSet));
				} else {
					var problems = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
								...
								_Utils_update(
									model,
									{
										problems: A2(
											$elm$core$List$map,
											function (e) {
												return $author$project$Page$Login$ServerError(e.message);
											},
											gQLErr)
									}),
								$elm$core$Platform$Cmd$none);
									...
									model,
									{
										problems: _List_fromArray(
											[
												...
												$author$project$ErrorHandling$httpErrorToString(httpErr))
											])
									}),
								$elm$core$Platform$Cmd$none);
						}
...
var $author$project$Page$Signup$GotResponse = function (a) {
	return {$: 'GotResponse', a: a};
};
var $author$project$Page$Signup$ServerError = function (a) {
	return {$: 'ServerError', a: a};
};
...
var $author$project$Api$makePublicMutation = F2(
	function (mutation, decodesTo) {
		return A2(
			$dillonkearns$elm_graphql$Graphql$Http$send,
			decodesTo,
			A2($dillonkearns$elm_graphql$Graphql$Http$mutationRequest, $author$project$Api$api_url, mutation));
	});
...
var $author$project$API$InputObject$encodeNewUserInput = function (input) {
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'firstName',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input.firstName))),
				_Utils_Tuple2(
				'lastName',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input.lastName))),
				_Utils_Tuple2(
				'email',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input.email))),
				_Utils_Tuple2(
				'phoneNumber',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input.phoneNumber))),
				_Utils_Tuple2(
				'password',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input.password)))
			]));
};
var $author$project$API$Mutation$signup = F2(
	function (requiredArgs, object_) {
		return A4(
			...
			_List_fromArray(
				[
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'userData', requiredArgs.userData, $author$project$API$InputObject$encodeNewUserInput)
				]),
			object_,
			$elm$core$Basics$identity);
	});
var $author$project$API$Object$Signup$token = function (object_) {
	return A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField, 'token', _List_Nil, object_, $elm$core$Basics$identity);
};
var $author$project$API$Object$Signup$user = function (object_) {
	return A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField, 'user', _List_Nil, object_, $elm$core$Basics$identity);
};
var $author$project$Api$signup = F3(
	function (form, msg, viewerSelectionSet) {
		var requiredFields = {
			userData: {email: form.email, firstName: form.firstName, lastName: form.lastName, password: form.password, phoneNumber: form.phoneNumber}
		};
		return A2(
			$author$project$Api$makePublicMutation,
			A2(
				$author$project$API$Mutation$signup,
				requiredFields,
				A2(
					viewerSelectionSet,
					$author$project$API$Object$Signup$user,
					$author$project$API$Object$Signup$token($author$project$Api$credSelectionSet))),
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, msg));
	});
...
var $author$project$Page$Signup$Email = {$: 'Email'};
var $author$project$Page$Signup$FirstName = {$: 'FirstName'};
var $author$project$Page$Signup$LastName = {$: 'LastName'};
var $author$project$Page$Signup$Password = {$: 'Password'};
var $author$project$Page$Signup$PhoneNumber = {$: 'PhoneNumber'};
var $author$project$Page$Signup$fieldsToValidate = _List_fromArray(
	[$author$project$Page$Signup$FirstName, $author$project$Page$Signup$LastName, $author$project$Page$Signup$Email, $author$project$Page$Signup$PhoneNumber, $author$project$Page$Signup$Password]);
var $author$project$Page$Signup$Trimmed = function (a) {
	return {$: 'Trimmed', a: a};
};
var $author$project$Page$Signup$trimFields = function (form) {
	return $author$project$Page$Signup$Trimmed(
		_Utils_update(
			form,
			{
				email: $elm$core$String$trim(form.email),
				firstName: $elm$core$String$trim(form.firstName),
				lastName: $elm$core$String$trim(form.lastName),
				password: $elm$core$String$trim(form.password),
				phoneNumber: $elm$core$String$trim(form.phoneNumber)
			}));
};
var $author$project$Page$Signup$InvalidEntry = F2(
	function (a, b) {
		return {$: 'InvalidEntry', a: a, b: b};
	});
var $author$project$Page$Signup$validateField = F2(
	function (_v0, field) {
		var form = _v0.a;
		return A2(
			$elm$core$List$map,
			$author$project$Page$Signup$InvalidEntry(field),
			function () {
				switch (field.$) {
					case 'FirstName':
						return $elm$core$String$isEmpty(form.firstName) ? _List_fromArray(
							['first name can\'t be blank.']) : _List_Nil;
					case 'LastName':
						return $elm$core$String$isEmpty(form.lastName) ? _List_fromArray(
							['last name can\'t be blank.']) : _List_Nil;
					case 'Email':
						return $elm$core$String$isEmpty(form.email) ? _List_fromArray(
							['email can\'t be blank.']) : _List_Nil;
					case 'PhoneNumber':
						return $elm$core$String$isEmpty(form.phoneNumber) ? _List_fromArray(
							['phone number can\'t be blank.']) : _List_Nil;
					default:
						return $elm$core$String$isEmpty(form.password) ? _List_fromArray(
							['password can\'t be blank.']) : _List_Nil;
				}
...
var $author$project$Page$Signup$validate = function (form) {
	var trimmedForm = $author$project$Page$Signup$trimFields(form);
	var _v0 = A2(
		$elm$core$List$concatMap,
		$author$project$Page$Signup$validateField(trimmedForm),
		$author$project$Page$Signup$fieldsToValidate);
	if (!_v0.b) {
		return $elm$core$Result$Ok(trimmedForm);
	} else {
		var problems = _v0;
		...
		switch (msg.$) {
			...
			case 'ToggleAgree':
				...
				return A2(
					...
					model);
			case 'SubmitForm':
				var _v1 = $author$project$Page$Signup$validate(model.form);
				if (_v1.$ === 'Ok') {
					var validForm = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
							...
							{problems: _List_Nil}),
						A3(
							$author$project$Api$signup,
							function (_v2) {
								var form = _v2.a;
								return form;
							}(validForm),
							$author$project$Page$Signup$GotResponse,
							$author$project$Viewer$selectionSet));
				} else {
					var problems = _v1.a;
					return _Utils_Tuple2(
								...
								_Utils_update(
									model,
									{
										problems: A2(
											$elm$core$List$map,
											function (e) {
												return $author$project$Page$Signup$ServerError(e.message);
											},
											gQLErr)
									}),
								$elm$core$Platform$Cmd$none);
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										problems: _List_fromArray(
											[
												$author$project$Page$Signup$ServerError(
												$author$project$ErrorHandling$httpErrorToString(httpErr))
											])
									}),
								$elm$core$Platform$Cmd$none);
...
var $author$project$Page$Welcome$CreateCompany = F2(
	function (a, b) {
		return {$: 'CreateCompany', a: a, b: b};
	});
var $author$project$Page$Welcome$JoinCompany = F2(
	function (a, b) {
		return {$: 'JoinCompany', a: a, b: b};
	});
var $author$project$Page$Welcome$JoinCompanyForm = function (name) {
	return {name: name};
};
var $author$project$Page$Welcome$NewCompanyForm = F3(
	function (name, email, phoneNumber) {
		return {email: email, name: name, phoneNumber: phoneNumber};
	});
var $author$project$Page$Welcome$update = F2(
	function (msg, model) {
		var session = $author$project$Page$Welcome$toSession(model);
		switch (msg.$) {
			case 'ShowCreateForm':
				var form = A3($author$project$Page$Welcome$NewCompanyForm, '', '', '');
				return _Utils_Tuple2(
					A2($author$project$Page$Welcome$CreateCompany, session, form),
					$elm$core$Platform$Cmd$none);
			case 'ShowJoinForm':
				var form = $author$project$Page$Welcome$JoinCompanyForm('');
				return _Utils_Tuple2(
					A2($author$project$Page$Welcome$JoinCompany, session, form),
					$elm$core$Platform$Cmd$none);
			...
			case 'ChangeName':
				var name = msg.a;
				if (model.$ === 'CreateCompany') {
					var form = model.b;
					return _Utils_Tuple2(
						A2(
							$author$project$Page$Welcome$CreateCompany,
							session,
							_Utils_update(
								form,
								{name: name})),
			...
			case 'SearchForCompany':
				var name = msg.a;
				if (model.$ === 'JoinCompany') {
					var form = model.b;
					return _Utils_Tuple2(
						A2(
							$author$project$Page$Welcome$JoinCompany,
							session,
							_Utils_update(
								form,
								{name: name})),
			...
			default:
				var session_ = msg.a;
				return _Utils_Tuple2(
					$author$project$Page$Welcome$Welcome(session_),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Brand$scaled = function (power) {
	return $elm$core$Basics$round(
		A3($mdgriffith$elm_ui$Element$modular, 16, 1.25, power));
};
var $author$project$Brand$defaultPaddingAmount = $author$project$Brand$scaled(2);
...
var $author$project$Brand$defaultBarPadding = A2($mdgriffith$elm_ui$Element$paddingXY, $author$project$Brand$defaultPaddingAmount, 4);
...
var $author$project$Brand$cardColor = A3($mdgriffith$elm_ui$Element$rgb255, 244, 244, 244);
var $author$project$Brand$primaryTextColorDBg = $author$project$Brand$cardColor;
...
var $author$project$Brand$secondaryColor = A3($mdgriffith$elm_ui$Element$rgb255, 72, 71, 70);
...
var $author$project$Brand$shadow = $mdgriffith$elm_ui$Element$Border$shadow(
	{
		blur: 4,
...
var $author$project$Layout$secondaryBan = function (content) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Border$color($author$project$Brand$cardColor),
...
var $author$project$Layout$primaryBtn = function (content) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Brand$primaryColor),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Brand$primaryTextColorDBg),
				$mdgriffith$elm_ui$Element$Font$size(
				$author$project$Brand$scaled(1)),
				$mdgriffith$elm_ui$Element$Border$rounded(6),
...
var $author$project$Brand$defaultFont = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$external(
			{name: 'Ubuntu', url: 'https://fonts.googleapis.com/css?family=Ubuntu&display=swap'}),
...
var $author$project$Page$Login$isFieldError = F2(
	function (field, problem) {
		if (problem.$ === 'InvalidEntry') {
			var f = problem.a;
			return _Utils_eq(f, field) ? true : false;
		} else {
			return false;
		}
	});
var $author$project$Page$Login$isServerError = function (problem) {
	if (problem.$ === 'ServerError') {
		return true;
	} else {
		return false;
	}
...
var $author$project$Brand$secondaryColorMuted = A3($mdgriffith$elm_ui$Element$rgb255, 125, 124, 122);
var $author$project$Brand$subtleTextColor = $author$project$Brand$secondaryColorMuted;
var $author$project$Page$Login$ChangeEmail = function (a) {
...
var $author$project$Brand$underlined = function (i) {
...
var $author$project$Layout$textInput = F2(
	function (fields, ok) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Brand$underlined(2),
					function () {
					if (ok) {
						return $mdgriffith$elm_ui$Element$Border$color($author$project$Brand$secondaryColorMuted);
					} else {
						return $mdgriffith$elm_ui$Element$Border$color($author$project$Brand$warningColor);
					}
				}(),
					$mdgriffith$elm_ui$Element$spacing(
					$author$project$Brand$scaled(1)),
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Border$color($author$project$Brand$primaryColor)
						])),
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
				]),
			fields);
	});
var $author$project$Brand$transparent = A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 0);
...
var $author$project$Page$Login$problemToString = function (problem) {
	if (problem.$ === 'InvalidEntry') {
		var str = problem.b;
		return str;
	} else {
...
var $author$project$Page$Login$viewErrors = function (problems) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($author$project$Brand$warningColor),
				$mdgriffith$elm_ui$Element$Font$size(
				$author$project$Brand$scaled(-1)),
				$mdgriffith$elm_ui$Element$width(
				A2(
					$mdgriffith$elm_ui$Element$maximum,
					$author$project$Brand$scaled(15),
			...
			function (err) {
				return A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(
							'* ' + $author$project$Page$Login$problemToString(err))
						]));
			},
			problems));
};
...
var $author$project$Layout$withErrors = F2(
...
var $author$project$Page$Login$viewEmail = F2(
	function (email, problems) {
		var ok = $elm$core$List$isEmpty(problems);
		return A2(
			$author$project$Layout$withErrors,
			A2(
				$author$project$Layout$textInput,
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Background$color($author$project$Brand$transparent),
								$mdgriffith$elm_ui$Element$focused(_List_Nil)
							]),
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('Email'),
							onChange: $author$project$Page$Login$ChangeEmail,
									...
									A2(
										...
										_List_fromArray(
											[
												function () {
												if (ok) {
													return $mdgriffith$elm_ui$Element$Font$color($author$project$Brand$subtleTextColor);
												} else {
													return $mdgriffith$elm_ui$Element$Font$color($author$project$Brand$warningColor);
												}
											}()
											]),
...
var $author$project$Page$Login$viewLoginBtn = A2(
		...
		]),
	{
		label: A2(
			...
			$mdgriffith$elm_ui$Element$text('Login')),
		onPress: $elm$core$Maybe$Just($author$project$Page$Login$SubmitForm)
	});
var $author$project$Page$Login$ChangePassword = function (a) {
	return {$: 'ChangePassword', a: a};
};
var $author$project$Page$Login$ToggleShowPassword = function (a) {
...
var $author$project$Brand$primaryColorMuted = A3($mdgriffith$elm_ui$Element$rgb255, 143, 189, 95);
var $author$project$Layout$eye = function (checked) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color($author$project$Brand$primaryColorMuted)
					]))
			]),
		checked ? A2(
			$mdgriffith$elm_ui$Element$image,
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
			{description: 'vOn', src: '/web/static/assets/visibility-24px.svg'}) : A2(
			$mdgriffith$elm_ui$Element$image,
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
			{description: 'vOff', src: '/web/static/assets/visibility_off-24px.svg'}));
};
var $author$project$Page$Login$viewPassword = F3(
	function (password, showPassword, problems) {
		var ok = $elm$core$List$isEmpty(problems);
		return A2(
			$author$project$Layout$withErrors,
			A2(
				...
				_List_fromArray(
					[
							...
							]),
						{
							...
							onChange: $author$project$Page$Login$ChangePassword,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
							...
							]),
						{
							...
							icon: $author$project$Layout$eye,
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('Show Password'),
							onChange: $author$project$Page$Login$ToggleShowPassword
						})
					]),
				ok),
			$author$project$Page$Login$viewErrors(problems));
	});
var $author$project$Page$Login$ToggleRememberMe = function (a) {
	return {$: 'ToggleRememberMe', a: a};
};
var $mdgriffith$elm_ui$Element$none = $mdgriffith$elm_ui$Internal$Model$Empty;
var $author$project$Layout$radio = function (checked) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Border$color($author$project$Brand$secondaryColorMuted),
				$mdgriffith$elm_ui$Element$Border$width(2),
				$mdgriffith$elm_ui$Element$width(
		...
		checked ? A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color($author$project$Brand$secondaryColorMuted),
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
...
var $author$project$Page$Login$viewRememberMe = function (rememberMe) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				{
					checked: rememberMe,
					icon: $author$project$Layout$radio,
					label: $mdgriffith$elm_ui$Element$Input$labelHidden('Remember Me'),
					onChange: $author$project$Page$Login$ToggleRememberMe
				}),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$color($author$project$Brand$subtleTextColor),
						$mdgriffith$elm_ui$Element$Font$size(
						$author$project$Brand$scaled(1)),
						$mdgriffith$elm_ui$Element$alignTop
					]),
				$mdgriffith$elm_ui$Element$text('Remember Me'))
			]));
};
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('New to rizzmi? '),
								A2(
								$mdgriffith$elm_ui$Element$link,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Font$color($author$project$Brand$primaryColor),
										$mdgriffith$elm_ui$Element$Font$semiBold
									]),
								{
									label: $mdgriffith$elm_ui$Element$text('Join us now'),
									url: $author$project$Route$toString($author$project$Route$Signup)
								})
							])),
						$author$project$Page$Login$viewErrors(
						A2($elm$core$List$filter, $author$project$Page$Login$isServerError, problems)),
						A2(
						$author$project$Page$Login$viewEmail,
						form.email,
						A2(
							$elm$core$List$filter,
							$author$project$Page$Login$isFieldError($author$project$Page$Login$Email),
							problems)),
						A3(
						$author$project$Page$Login$viewPassword,
						form.password,
						form.showPassword,
						A2(
							$elm$core$List$filter,
							$author$project$Page$Login$isFieldError($author$project$Page$Login$Password),
							problems)),
						$author$project$Page$Login$viewRememberMe(form.rememberMe),
						$author$project$Page$Login$viewLoginBtn
					])));
	});
...
var $author$project$Page$Signup$isServerError = function (problem) {
	if (problem.$ === 'ServerError') {
		return true;
	} else {
		return false;
...
var $author$project$Page$Signup$ToggleAgree = function (a) {
	return {$: 'ToggleAgree', a: a};
};
var $author$project$Page$Signup$viewAgreement = function (rememberMe) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
					...
					]),
				{
					checked: rememberMe,
					icon: $author$project$Layout$radio,
					label: $mdgriffith$elm_ui$Element$Input$labelHidden('Terms & Conditions'),
					onChange: $author$project$Page$Signup$ToggleAgree
				}),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('I agree to the '),
						A2(
						$mdgriffith$elm_ui$Element$link,
						_List_fromArray(
							[
						...
						{
							label: $mdgriffith$elm_ui$Element$text('Terms & Conditions'),
							url: '#'
						}),
						$mdgriffith$elm_ui$Element$text('.')
					]))
...
var $author$project$Page$Signup$ChangeEmail = function (a) {
	return {$: 'ChangeEmail', a: a};
};
var $author$project$Page$Signup$problemToString = function (problem) {
	if (problem.$ === 'InvalidEntry') {
		var str = problem.b;
		return str;
	} else {
...
var $author$project$Page$Signup$viewErrors = function (problems) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			function (err) {
				return A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(
							'* ' + $author$project$Page$Signup$problemToString(err))
						]));
			},
			problems));
};
var $author$project$Page$Signup$viewEmail = F2(
	function (email, problems) {
		var ok = $elm$core$List$isEmpty(problems);
		return A2(
			$author$project$Layout$withErrors,
			A2(
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('Email'),
							onChange: $author$project$Page$Signup$ChangeEmail,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
				...
				$elm$core$List$isEmpty(problems)),
			$author$project$Page$Signup$viewErrors(problems));
	});
var $author$project$Page$Signup$ChangeFirstName = function (a) {
	return {$: 'ChangeFirstName', a: a};
};
var $author$project$Page$Signup$ChangeLastName = function (a) {
	return {$: 'ChangeLastName', a: a};
};
...
var $author$project$Page$Signup$viewName = F3(
	function (firstName, lastName, problems) {
		var lnp = A2(
			$elm$core$List$filter,
			$author$project$Page$Signup$isFieldError($author$project$Page$Signup$LastName),
			problems);
		var lnOk = $elm$core$List$isEmpty(lnp);
		var fnp = A2(
			$elm$core$List$filter,
			$author$project$Page$Signup$isFieldError($author$project$Page$Signup$FirstName),
			problems);
		var fnOk = $elm$core$List$isEmpty(fnp);
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$author$project$Brand$underlined(2),
								function () {
								var _v0 = $elm$core$List$isEmpty(fnp);
								if (_v0) {
									return $mdgriffith$elm_ui$Element$Border$color($author$project$Brand$secondaryColorMuted);
								} else {
									return $mdgriffith$elm_ui$Element$Border$color($author$project$Brand$warningColor);
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('First Name'),
							onChange: $author$project$Page$Signup$ChangeFirstName,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
					...
					$author$project$Page$Signup$viewErrors(fnp)),
					A2(
					$author$project$Layout$withErrors,
					A2(
						$mdgriffith$elm_ui$Element$Input$text,
						_List_fromArray(
							[
								...
								$author$project$Brand$underlined(2),
								function () {
								var _v2 = $elm$core$List$isEmpty(lnp);
								if (_v2) {
									return $mdgriffith$elm_ui$Element$Border$color($author$project$Brand$secondaryColorMuted);
								} else {
									return $mdgriffith$elm_ui$Element$Border$color($author$project$Brand$warningColor);
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('Last Name'),
							onChange: $author$project$Page$Signup$ChangeLastName,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
					...
					$author$project$Page$Signup$viewErrors(lnp))
				]));
	});
var $author$project$Page$Signup$ChangePassword = function (a) {
	return {$: 'ChangePassword', a: a};
};
var $author$project$Page$Signup$ToggleShowPassword = function (a) {
	return {$: 'ToggleShowPassword', a: a};
};
...
var $author$project$Page$Signup$viewPassword = F3(
	function (password, showPassword, problems) {
		var ok = $elm$core$List$isEmpty(problems);
		return A2(
			$author$project$Layout$withErrors,
			A2(
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('Password'),
							onChange: $author$project$Page$Signup$ChangePassword,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
							...
							]),
						{
							...
							icon: $author$project$Layout$eye,
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('Show Password'),
							onChange: $author$project$Page$Signup$ToggleShowPassword
						})
					]),
				$elm$core$List$isEmpty(problems)),
			$author$project$Page$Signup$viewErrors(problems));
	});
var $author$project$Page$Signup$ChangePhoneNumber = function (a) {
	return {$: 'ChangePhoneNumber', a: a};
};
var $author$project$Page$Signup$viewPhoneNumber = F2(
	function (phone, problems) {
		var ok = $elm$core$List$isEmpty(problems);
		return A2(
			$author$project$Layout$withErrors,
			A2(
				...
				_List_fromArray(
					[
							...
							]),
						{
							...
							onChange: $author$project$Page$Signup$ChangePhoneNumber,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
...
var $author$project$Page$Signup$SubmitForm = {$: 'SubmitForm'};
var $author$project$Page$Signup$viewSignupBtn = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$centerX,
		...
		]),
	{
		...
		onPress: $elm$core$Maybe$Just($author$project$Page$Signup$SubmitForm)
	});
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('A rizzmi member? '),
								A2(
								$mdgriffith$elm_ui$Element$link,
								_List_fromArray(
									[
								...
								{
									label: $mdgriffith$elm_ui$Element$text('Come on in'),
									url: $author$project$Route$toString($author$project$Route$Login)
								})
							])),
						$author$project$Page$Signup$viewErrors(
						A2($elm$core$List$filter, $author$project$Page$Signup$isServerError, problems)),
						A3($author$project$Page$Signup$viewName, form.firstName, form.lastName, problems),
						A2(
						$author$project$Page$Signup$viewEmail,
						form.email,
						A2(
							$elm$core$List$filter,
							$author$project$Page$Signup$isFieldError($author$project$Page$Signup$Email),
							problems)),
						A2(
						$author$project$Page$Signup$viewPhoneNumber,
						form.phoneNumber,
						A2(
							$elm$core$List$filter,
							$author$project$Page$Signup$isFieldError($author$project$Page$Signup$PhoneNumber),
							problems)),
						A3(
						$author$project$Page$Signup$viewPassword,
						form.password,
						form.showPassword,
						A2(
							$elm$core$List$filter,
							$author$project$Page$Signup$isFieldError($author$project$Page$Signup$Password),
							problems)),
						$author$project$Page$Signup$viewAgreement(form.agree),
						$author$project$Page$Signup$viewSignupBtn
					])));
	});
...
var $author$project$Page$Welcome$submitBan = function (content) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $author$project$Page$Welcome$ShowWelcome = {$: 'ShowWelcome'};
var $author$project$Page$Welcome$viewBackBtn = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: A2(
			$mdgriffith$elm_ui$Element$image,
			_List_Nil,
			{description: 'Back', src: 'web/static/assets/arrow_back_ios-24px.svg'}),
		onPress: $elm$core$Maybe$Just($author$project$Page$Welcome$ShowWelcome)
	});
var $author$project$Page$Welcome$ChangeEmail = function (a) {
	return {$: 'ChangeEmail', a: a};
};
var $author$project$Page$Welcome$viewEmail = function (email) {
	return A2(
		$author$project$Layout$textInput,
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$Input$labelHidden('Company Email'),
					onChange: $author$project$Page$Welcome$ChangeEmail,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							A2(
								...
								$mdgriffith$elm_ui$Element$text('Company Email')))),
					text: email
				})
			]),
		true);
};
var $author$project$Page$Welcome$ChangeName = function (a) {
	return {$: 'ChangeName', a: a};
};
var $author$project$Page$Welcome$viewName = function (name) {
	return A2(
		$author$project$Layout$textInput,
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$Input$labelHidden('Company Name'),
					onChange: $author$project$Page$Welcome$ChangeName,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							A2(
								...
								$mdgriffith$elm_ui$Element$text('Company Name')))),
					text: name
				})
			]),
		true);
};
var $author$project$Page$Welcome$ChangePhoneNumber = function (a) {
	return {$: 'ChangePhoneNumber', a: a};
};
var $author$project$Page$Welcome$viewPhoneNumber = function (phone) {
	return A2(
		$author$project$Layout$textInput,
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$Input$labelHidden('Company Phone Number'),
					onChange: $author$project$Page$Welcome$ChangePhoneNumber,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							A2(
								...
								$mdgriffith$elm_ui$Element$text('Company Phone number')))),
					text: phone
				})
			]),
		true);
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$alignLeft]),
							$author$project$Page$Welcome$viewBackBtn),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$centerX]),
					...
					$author$project$Page$Welcome$viewName(form.name),
					$author$project$Page$Welcome$viewEmail(form.email),
					$author$project$Page$Welcome$viewPhoneNumber(form.phoneNumber),
					$author$project$Page$Welcome$submitBan(
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Page$Welcome$viewName(form.name),
					$author$project$Page$Welcome$submitBan(
					$mdgriffith$elm_ui$Element$text('Join'))
				])));
};
var $author$project$Page$Welcome$ShowCreateForm = {$: 'ShowCreateForm'};
var $author$project$Page$Welcome$viewCreateBtn = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width(
			...
			$mdgriffith$elm_ui$Element$height(
			$mdgriffith$elm_ui$Element$px(
				$author$project$Brand$scaled(13))),
			$mdgriffith$elm_ui$Element$Font$bold,
			$mdgriffith$elm_ui$Element$Font$size(
			$author$project$Brand$scaled(3)),
			$mdgriffith$elm_ui$Element$Font$color($author$project$Brand$primaryTextColorDBg),
		...
		]),
	{
		label: A2(
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
			$mdgriffith$elm_ui$Element$text('Create a company')),
		onPress: $elm$core$Maybe$Just($author$project$Page$Welcome$ShowCreateForm)
	});
var $author$project$Page$Welcome$ShowJoinForm = {$: 'ShowJoinForm'};
var $author$project$Page$Welcome$viewJoinBtn = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width(
		...
		]),
	{
		label: A2(
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
			$mdgriffith$elm_ui$Element$text('Join a company')),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$author$project$Page$Welcome$viewCreateBtn, $author$project$Page$Welcome$viewJoinBtn]))
				])));
};
			...
			return {
				body: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Page Not Implemented')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
